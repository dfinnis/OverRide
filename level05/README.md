...
Let's take a deeper look at the program. See [dissasembly notes](https://github.com/dfinnis/Override/blob/main/level05/disassembly_notes.md) for detailed gdb assembly breakdown.
